export function verifyEmailTemplate(params: { userName: string; verificationUrl: string }): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;color:#52525b;font-size:15px;line-height:24px;">
                ...
                Thanks for signing up for TaskFlow. Please verify your email address by clicking the button below.
              </p>
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
                <tr>
                  <td style="background-color:#18181b;border-radius:8px;">
                    <a href="${params.verificationUrl}" target="_blank" style="display:inline-block;padding:12px 32px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;">
                      Verify Email
                    </a>
                  </td>
                </tr>
